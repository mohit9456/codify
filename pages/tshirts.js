...
const Tshirts = ({products}) => {
  return (
    <div>
      <Head>
        <title>see the collections of Tshirts in codify.com</title>
      ...
      <section className="text-gray-600 body-font min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          ...
          { Object.keys(products).length === 0 && <p className='font-bold'>Sorry all the Tshirts are currently out of stock. New stock coming soon ! Stay tuned. </p>}
